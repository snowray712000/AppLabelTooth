...
pathSTL = r"D:\coding\透明牙套\AI訓練資料_瑋哥試轉20筆b\Template1-0_lower_Stage1_step0_0629_Nicky.stl"
pathSTL = r"D:\coding\透明牙套\AI訓練資料_瑋哥試轉20筆b\Template1-0_upper_Stage1_step0_0629_Nicky.stl"

# path label 是 .stl 換成 .mgn
pathLabel = pathSTL.replace(".stl", ".pts")
#%%
# 讀 text x,y,z,l
